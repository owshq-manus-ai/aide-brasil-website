          ...
          >
            ...
            <div className="relative rounded-2xl overflow-hidden">
              ...
              <div className="relative p-8">
                {/* Header - Clean style matching Onyx conversation */}
                <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-8 pb-4 border-b border-gray-800/50 gap-3">
        ...
        <div className="relative z-10 py-12 sm:py-16 lg:py-20">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center">
            ...
            <motion.div
              ...
              className="flex justify-center items-center h-full onyx-orb-container"
            >
              <div className={`relative w-80 h-80 flex items-center justify-center ${isMobile ? 'onyx-orb-mobile' : 'onyx-orb'}`}>
                {/* Flowing particles from above - disabled on mobile */}
                ...
                {/* Mystical Particle Field from Oracle - disabled on mobile */}
                {!isMobile && (
                ...
                {/* Energy Waves - disabled on mobile */}
                {!isMobile && [0, 1, 2].map((wave) => (
                  <motion.div
          ...
          >
            ...
            <div className="relative max-w-3xl mx-auto">
              ...
              >
                {/* Chat Header */}
                <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between px-4 sm:px-6 py-4 border-b border-gray-800/50 gap-3">
                  <div className="flex flex-wrap items-center gap-2 sm:gap-3">
                    <div className="w-2 h-2 bg-green-400 rounded-full animate-pulse" />
                    <span className="text-gray-400 text-sm font-medium">#ask-the-expert</span>
                    <span className="text-gray-500 text-sm">• Online</span>
