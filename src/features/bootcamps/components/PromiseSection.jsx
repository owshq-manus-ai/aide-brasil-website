    ...
    <section id="promise" className="relative py-24 bg-[#0a0a0a] overflow-hidden">
      ...
      <div className="absolute inset-0">
        <div
          ...
          style={{
            background: `
              radial-gradient(ellipse 600px 300px at 50% 0%, rgba(251, 146, 60, 0.08) 0%, transparent 50%),
              radial-gradient(ellipse 400px 200px at 80% 100%, rgba(245, 158, 11, 0.05) 0%, transparent 50%)
            `,
          }}
        />
        <div
        ...
        >
          <div className="relative inline-block">
            ...
            <div
              ...
              style={{
                background: 'linear-gradient(90deg, rgba(251, 146, 60, 0.3), rgba(245, 158, 11, 0.3), rgba(251, 146, 60, 0.3))',
              }}
            />

            <motion.div
              className="relative bg-gradient-to-r from-[#1a1a1a] via-[#1f1510] to-[#1a1a1a] border-2 border-orange-500/40 rounded-2xl px-10 py-8"
