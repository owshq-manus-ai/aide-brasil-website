...
import {
  ...
  Gauge, Code, Bug, Settings, FileText, Search, Puzzle, BarChart3
} from 'lucide-react'
...
function ContextEngineeringWebinar() {
  ...
  // Webinar data specific to Context Engineering
  const webinar = {
    ...
    agenda: [
      ...
      },
      {
        time: '21:30',
        module: 'Encerramento',
        topic: 'Production Context Management',
        description: 'Escale context engineering - caching, dynamic context, A/B testing de prompts e monitoring de qualidade',
        icon: Rocket
      }
    ],
    ...
    benefits: [
      {
        ...
        description: 'Construa prompts que funcionam de primeira',
        duration: '30 min',
        level: 'Intermediario'
      },
      {
      ...
      },
      {
        ...
        description: 'Maximize resultado com menos tokens',
        duration: '20 min',
        level: 'Intermediario'
      },
      {
        ...
        description: 'Patterns usados por empresas lideres',
        duration: '25 min',
        level: 'Expert'
      },
      {
    ...
    instructor: {
      ...
      achievements: [
        'Implementou context engineering em +40 projetos de LLM',
        'Reduziu custos de API em 60% com optimization',
        'Treinou +800 desenvolvedores em prompt engineering',
        'Contributor em frameworks open-source de RAG'
      ]
    },
    ...
    statistics: [
      {
        ...
        suffix: '%',
        label: 'Melhor Output',
        description: 'Com contexto bem estruturado',
        color: 'green-500',
      ...
      },
      {
        ...
        suffix: 'x',
        label: 'Menos Tokens',
        description: 'Com compression eficiente',
        color: 'emerald-500',
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // Get webhook configuration for Context Engineering webinar
      const webhookConfig = webhookEndpoints.webinars['dominando-context-engineering']

      // Prepare data with webhook metadata
      const submissionData = {
        ...formData,
        ...webhookConfig.metadata,
        source: 'webinar-context-engineering',
  ...
  return (
    <div className="min-h-screen text-white overflow-x-hidden relative">
      {/* FIXED BACKGROUND SYSTEM - GREEN THEME */}
      <div className="fixed inset-0" style={{ zIndex: -10 }}>
        ...
        {/* Layer 2: Green metallic overlays */}
        <div
          style={{
            background: `radial-gradient(circle at 20% 20%, rgba(16, 185, 129, 0.1) 0%, transparent 50%),
                        ...
                        radial-gradient(circle at 40% 70%, rgba(52, 211, 153, 0.06) 0%, transparent 50%)`,
            position: 'absolute',
            inset: 0
          }}
        />
        ...
        <div
          style={{
            background: `repeating-linear-gradient(
              ...
              transparent,
              transparent 2px,
              rgba(16, 185, 129, 0.01) 2px,
              rgba(16, 185, 129, 0.01) 4px
            )`,
            position: 'absolute',
            inset: 0
          }}
      ...
      <div className="relative pt-24 px-6 z-10">
        <div className="max-w-7xl mx-auto">
          <Link
            to="/webinars"
            className="inline-flex items-center gap-2 text-white/70 hover:text-emerald-500 transition-colors"
          >
            <ArrowLeft className="w-4 h-4" />
            <span>Voltar aos Webinarios</span>
          </Link>
        </div>
      </div>
        ...
        <div className="relative z-10 max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-12 items-start">
            ...
            <div>
              ...
              {/* Main title with gradient on "Context Engineering" */}
              <h1 className="text-5xl md:text-7xl font-bold mb-4 relative">
                <span className="text-white">Dominando </span>
                <span className="bg-gradient-to-r from-white via-emerald-500/80 to-white bg-clip-text text-transparent">
                  Context Engineering
                </span>
              </h1>

              {/* Subtitle */}
              <h2 className="text-xl md:text-2xl text-emerald-500 mb-3 font-medium">
                {webinar.subtitle}
              </h2>
              ...
              <div className="space-y-4 mb-8">
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-white text-base">Entenda como LLMs processam e priorizam contexto</span>
                </div>
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 bg-gradient-to-br from-emerald-500 to-green-500 rounded-xl flex items-center justify-center flex-shrink-0">
                    <FileText className="w-5 h-5 text-white" />
                  </div>
                  <span className="text-white text-base">Construa prompts estruturados que funcionam de primeira</span>
                </div>
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 bg-gradient-to-br from-emerald-500 to-green-500 rounded-xl flex items-center justify-center flex-shrink-0">
                    <Search className="w-5 h-5 text-white" />
                  </div>
                  <span className="text-white text-base">Otimize RAG pipelines para contexto relevante</span>
                </div>
              </div>
            ...
            <div className="space-y-8 relative">
              ...
              {/* Green overlay for better blending */}
              <div
                className="absolute inset-0"
                style={{
                  background: 'radial-gradient(ellipse at center, rgba(16, 185, 129, 0.2) 0%, rgba(34, 197, 94, 0.1) 50%, transparent 80%)',
                  zIndex: 1,
                  pointerEvents: 'none'
                }}
              />
              ...
              <motion.div
                ...
                className="bg-gradient-to-br from-emerald-500/10 to-green-500/10 backdrop-blur-sm rounded-2xl p-8 border border-emerald-500/20 relative"
                style={{ zIndex: 2 }}
              >
              ...
              <motion.div
                ...
                className="relative bg-gradient-to-br from-emerald-900/30 to-green-900/20 backdrop-blur-sm rounded-2xl p-8 border-2 border-emerald-500/30"
                style={{ zIndex: 2 }}
              >
                {/* 4 Floating Corner Icons with Animations */}
                <div className="absolute -top-6 -left-6">
                  <motion.div
                    className="w-14 h-14 bg-gradient-to-br from-emerald-500 to-green-500 rounded-2xl flex items-center justify-center shadow-lg shadow-emerald-500/30"
                    animate={{ y: [0, -5, 0] }}
                ...
                <div className="absolute -bottom-6 -left-6">
                  <motion.div
                    className="w-12 h-12 bg-gradient-to-br from-emerald-600 to-green-500 rounded-xl flex items-center justify-center shadow-lg shadow-emerald-500/30"
                    animate={{ y: [0, -4, 0] }}
                ...
                <div className="absolute -bottom-6 -right-6">
                  <motion.div
                    className="w-10 h-10 bg-gradient-to-br from-green-600 to-emerald-500 rounded-lg flex items-center justify-center shadow-lg shadow-green-500/30"
                    animate={{ y: [0, -2, 0] }}
                  ...
                  <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        required
                        className="w-full pl-12 pr-4 py-2.5 bg-gray-800/50 border border-gray-700 rounded-lg text-white placeholder-gray-400 focus:border-emerald-500 focus:outline-none transition-colors"
                      />
                    </div>
                    <div className="relative">
                    ...
                    <div className="relative">
                      ...
                      <span className="absolute right-3 top-1/2 transform -translate-y-1/2 text-xs text-emerald-400 font-medium">WhatsApp</span>
                      <input
                        type="tel"
                        name="phone"
                        ...
                        required
                        className="w-full pl-12 pr-20 py-2.5 bg-gray-800/50 border border-gray-700 rounded-lg text-white placeholder-gray-400 focus:border-emerald-500 focus:outline-none transition-colors"
                      />
                    </div>
                    ...
                    <button
                      ...
                      className="w-full bg-gradient-to-r from-emerald-500 to-green-500 text-white font-bold py-3 rounded-lg hover:from-emerald-600 hover:to-green-600 transform transition-all duration-300 hover:scale-105 disabled:opacity-50 disabled:cursor-not-allowed"
                    >
      ...
      <section className="py-20 bg-gradient-to-b from-transparent via-emerald-900/5 to-transparent px-6">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-5xl md:text-7xl font-bold mb-6 text-white leading-tight text-center">
            Pare de <span className="text-red-500 line-through decoration-4">Adivinhar Prompts</span>
            <br />
            <span className="text-4xl md:text-6xl">Comece a </span>
            <span className="bg-clip-text text-transparent bg-gradient-to-r from-emerald-500 via-green-500 to-emerald-500 text-5xl md:text-7xl">
              Engenheirar Contextos
            </span>
          </h2>

          <p className="text-xl text-white/70 max-w-4xl mx-auto mb-16 text-center">
            A diferenca entre desenvolvedores que lutam com outputs inconsistentes e aqueles que entregam IA precisa esta no dominio do Context Engineering
          </p>
          ...
          <div className="grid lg:grid-cols-2 gap-6">
            ...
            <div className="bg-gradient-to-br from-red-900/30 to-red-800/20 backdrop-blur-sm rounded-3xl p-8 border-2 border-red-500/30 relative">
              ...
              <h3 className="text-2xl font-bold text-white mb-2">Prompts por Tentativa e Erro</h3>
              <p className="text-red-400 text-lg mb-6">O caminho frustrante e inconsistente</p>

              <div className="space-y-3 mb-6">
                <div className="flex justify-between text-sm">
                  <span className="text-white/70">Prompts que funcionam as vezes</span>
                  <span className="text-red-400 font-bold">Inconsistente</span>
                </div>
                <div className="flex justify-between text-sm">
                  <span className="text-white/70">Context window desperdicado</span>
                  <span className="text-red-400 font-bold">Tokens perdidos</span>
                </div>
                <div className="flex justify-between text-sm">
                ...
                <div className="flex justify-between text-sm">
                  <span className="text-white/70">Sem metodologia para escalar</span>
            ...
            <div className="relative">
              ...
              <div className="absolute -top-4 left-1/2 -translate-x-1/2 z-20">
                <motion.div animate={{ y: [0, -3, 0] }} transition={{ duration: 2, repeat: Infinity }}>
                  <div className="relative bg-gradient-to-r from-emerald-500 to-green-500 px-5 py-2 shadow-2xl shadow-emerald-500/50">
              ...
              {/* Main card */}
              <div className="bg-gradient-to-br from-emerald-900/30 to-green-900/20 backdrop-blur-sm rounded-3xl p-8 border-2 border-emerald-500/40">
                <div className="flex items-center justify-between mb-4 pt-2">
                  <div className="w-16 h-16 bg-gradient-to-br from-emerald-500/30 to-green-500/30 rounded-2xl flex items-center justify-center border-2 border-emerald-500/50">
                ...
                <h3 className="text-2xl font-bold text-white mb-2">Com Dominio de Context Engineering</h3>
                <p className="text-emerald-500 text-lg font-medium mb-6">Framework cientifico para contextos perfeitos</p>

                <div className="space-y-3 mb-6">
                  <div className="flex justify-between text-sm">
                    <span className="text-white/70">Prompts estruturados que funcionam sempre</span>
                    <span className="text-emerald-400 font-bold">Consistente</span>
                  </div>
                  <div className="flex justify-between text-sm">
                    <span className="text-white/70">Cada token otimizado para maximo impacto</span>
                  ...
                  <div className="flex justify-between text-sm">
                    ...
                    <span className="text-emerald-400 font-bold">60% economia</span>
                  </div>
                  <div className="flex justify-between text-sm">
                    <span className="text-white/70">Outputs prontos para uso direto</span>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {webinar.benefits.map((benefit, index) => (
              <motion.div
                ...
                viewport={{ once: true }}
              >
                <div className="bg-white/5 backdrop-blur-sm rounded-2xl p-8 border border-emerald-500/20 hover:border-emerald-500/40 transition-colors relative">
                  ...
                  <div className="w-16 h-16 bg-gradient-to-br from-emerald-500 to-green-500 rounded-2xl flex items-center justify-center mb-6 shadow-lg shadow-emerald-500/30">
          ...
          <div className="space-y-6 max-w-4xl mx-auto">
            {webinar.agenda.map((item, index) => (
              <motion.div
                ...
                transition={{ delay: index * 0.1 }}
                viewport={{ once: true }}
                className="bg-white/5 backdrop-blur-sm rounded-2xl p-8 border border-emerald-500/20 hover:border-emerald-500/40 transition-colors relative"
              >
      ...
      <section className="py-20 bg-gradient-to-b from-transparent via-emerald-900/5 to-transparent px-6">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="max-w-4xl mx-auto">
            <div className="bg-white/5 backdrop-blur-sm rounded-3xl p-12 border border-emerald-500/20 relative overflow-hidden">
              ...
              <div
                className="absolute inset-0"
                style={{
                  background: 'linear-gradient(135deg, rgba(16, 185, 129, 0.4) 0%, rgba(34, 197, 94, 0.2) 50%, rgba(16, 185, 129, 0.3) 100%)',
                  zIndex: 1,
                  pointerEvents: 'none'
                }}
              />
              ...
              <div className="grid md:grid-cols-2 gap-12 items-center relative" style={{ zIndex: 2 }}>
                ...
                <div className="relative">
                  {/* Animated green glow behind photo */}
                  <div className="absolute -inset-4 bg-gradient-to-r from-emerald-600 to-green-600 rounded-2xl opacity-30 blur-xl animate-pulse" />
                  ...
                  <div className="relative overflow-hidden rounded-2xl">
                    ...
                    {/* Green gradient overlay for cyberpunk effect */}
                    <div className="absolute inset-0 bg-gradient-to-t from-emerald-900/40 via-transparent to-green-900/20 mix-blend-multiply" />
                  </div>

                  {/* Corner accent decorations */}
                  <div className="absolute top-0 left-0 w-12 h-12 border-t-2 border-l-2 border-emerald-500 rounded-tl-2xl" />
                  <div className="absolute top-0 right-0 w-12 h-12 border-t-2 border-r-2 border-emerald-500 rounded-tr-2xl" />
                  <div className="absolute bottom-0 left-0 w-12 h-12 border-b-2 border-l-2 border-emerald-500 rounded-bl-2xl" />
                  <div className="absolute bottom-0 right-0 w-12 h-12 border-b-2 border-r-2 border-emerald-500 rounded-br-2xl" />

                  {/* Tech badge overlay */}
                  <div className="absolute bottom-4 left-4 bg-black/80 backdrop-blur-sm px-3 py-1.5 rounded-lg border border-emerald-500/50">
                    <div className="flex items-center gap-2">
                      <div className="w-2 h-2 bg-emerald-500 rounded-full animate-pulse" />
                      <span className="text-xs text-emerald-400 font-mono">CONTEXT EXPERT</span>
                    </div>
                  </div>
                </div>
                ...
                <div className="relative">
                  ...
                  <p className="text-emerald-500 font-semibold mb-1">{webinar.instructor.title}</p>
      ...
      <section className="py-20 bg-gradient-to-b from-transparent via-emerald-900/5 to-transparent px-6">
        <div className="max-w-6xl mx-auto">
          ...
          {/* Testimonial */}
          <div className="bg-gradient-to-r from-emerald-500/20 to-green-500/20 p-[1px] rounded-2xl max-w-3xl mx-auto">
            <div className="bg-black/50 backdrop-blur-sm rounded-2xl p-8 relative overflow-hidden">
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-emerald-500">{webinar.testimonial.role}</p>
                </div>
              </div>
              </div>
            </div>
          ...
          <div className="relative">
            ...
            <div className="max-w-4xl mx-auto bg-gradient-to-br from-green-900/20 to-emerald-900/10 backdrop-blur-sm rounded-3xl p-12 border-2 border-green-500/30">
              ...
              <h2 className="text-4xl md:text-5xl font-bold text-center mb-6">
                Sua Vaga esta <span className="text-green-500">100% Garantida</span>
              </h2>
      ...
      <section className="py-20 bg-gradient-to-b from-transparent via-emerald-900/5 to-transparent px-6">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-5xl md:text-6xl font-bold text-center mb-4">
            <span className="bg-gradient-to-r from-emerald-500 via-white to-emerald-500 bg-clip-text text-transparent drop-shadow-2xl">
              Pronto para Dominar Context Engineering?
            </span>
          </h2>
          ...
          <div className="max-w-2xl mx-auto">
            <div className="bg-gradient-to-br from-emerald-900/40 to-green-900/30 backdrop-blur-sm rounded-3xl p-10 border-2 border-emerald-500/40">
              ...
              <form onSubmit={handleSubmit} className="space-y-4 mb-8">
                <input
                  ...
                  name="name"
                  placeholder="Seu nome completo"
                  className="w-full px-4 py-3 bg-gray-800/50 border border-gray-700 rounded-lg text-white placeholder-gray-400 focus:border-emerald-500 focus:outline-none transition-colors"
                  value={formData.name}
                  onChange={handleInputChange}
                  required
                />
                ...
                <button
                  type="submit"
                  disabled={isSubmitting}
                  className="w-full bg-gradient-to-r from-emerald-500 to-green-500 text-white font-bold py-4 rounded-lg hover:from-emerald-600 hover:to-green-600 transform transition-all duration-300 hover:scale-105 text-lg disabled:opacity-50 disabled:cursor-not-allowed"
                >
              ...
              <div className="grid md:grid-cols-3 gap-4 text-center">
                ...
                <div className="text-white/60">
                  ...
                  <div className="text-sm">Guia Context Engineering</div>
                </div>
              </div>
            </div>
          </div>
...
export default ContextEngineeringWebinar
